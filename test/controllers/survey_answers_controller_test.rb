...
class SurveyAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create survey_answer" do
    assert_difference("SurveyAnswer.count") do
      post survey_answers_url, params: { survey_answer: { answer: @survey_answer.answer, survey_id: @survey_answer.survey_id } }
    end
  ...
  test "should update survey_answer" do
    patch survey_answer_url(@survey_answer), params: { survey_answer: { answer: @survey_answer.answer, survey_id: @survey_answer.survey_id } }
